...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "32", height: "32", href: "/images/dojo/logo.png" })));
};
...
var Icon$v = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/dojo/9.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/dojo/9.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 189 50" }, props),
        React__default['default'].createElement("image", { width: "189", height: "50", href: isDark ? '/images/dojo/LogoTextNewDark.png' : '/images/dojo/LogoTextNewWhite.png' })));
};
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    GithubIcon: Icon$1b,
    DocsIcon: Icon$1c,
    FeaturesIcon: Icon$1d,
    AnalyticsIcon: Icon$1e,
    MediumIcon: Icon$1f,
    ListingIcon: Icon$1g
});
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { style: { alignItems: 'center' } },
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$Q, { width: "24px", color: "primary" })) : (React__default['default'].createElement(Icon$P, { width: "24px", color: "primary" }))),
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { size: "sm", onClick: function () {
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$1n, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var DesktopOnlyText = styled__default['default'].span(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: none;\n\n  ", " {\n    display: inline;\n    margin-right: 6px;\n  }\n"], ["\n  display: none;\n\n  ", " {\n    display: inline;\n    margin-right: 6px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.lg;
});
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", style: { marginRight: '8px' }, onClick: function () {
                        window.location.href = "https://" + (inBsc ? 'polygon' : 'bsc') + ".dojofarm.finance";
                    } },
                    !inBsc ? React__default['default'].createElement(Icon$I, { style: { marginRight: '6px' }, color: "primary" }) : React__default['default'].createElement(Icon$J, { style: { marginRight: '6px' }, color: "primary" }),
                    " ",
                    React__default['default'].createElement(DesktopOnlyText, null, "Switch to"),
                    " ",
                    inBsc ? 'Polygon' : 'BSC'),

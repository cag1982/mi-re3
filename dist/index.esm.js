...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/sandman/logo.png" })));
};
...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/sandman/9.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/sandman/9.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 189 50" }, props),
        React.createElement("image", { width: "189", height: "50", href: isDark ? '/images/sandman/LogoTextNewDark.png' : '/images/sandman/LogoTextNewWhite.png' })));
};
        ...
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, onClick: handleClick },
                ...
                React.createElement(LinkLabel, { isPushed: isPushed },
                    entry.label,
                    " ",
                    entry.tag ? (React.createElement(Tag, { style: { fontSize: '12px', padding: '0 4px', lineHeight: '1', height: '20px', borderSize: '1px', marginLeft: '4px' }, outline: true, variant: entry.tag.variant }, entry.tag.title)) : null))));
    })));
};
var templateObject_1$B;
...
var StyledDefiYield = styled.a(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  padding: 4px 8px 0;\n  margin: 0 12px 12px;\n  background-color: rgba(255, 255, 255, 0.25);\n  border-radius: 6px;\n  svg {\n    width: 100%;\n    height: auto;\n  }\n"], ["\n  padding: 4px 8px 0;\n  margin: 0 12px 12px;\n  background-color: rgba(255, 255, 255, 0.25);\n  border-radius: 6px;\n  svg {\n    width: 100%;\n    height: auto;\n  }\n"])));
...
var PaladinTag = styled(Tag)(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n  border-color: #FFB74D;\n  color: #fff;\n  text-shadow:\n    0 0 7px #fff,\n    0 0 10px #fff,\n    0 0 21px #fff,\n    0 0 42px #0fa,\n    0 0 82px #0fa,\n    0 0 92px #0fa,\n    0 0 102px #0fa,\n    0 0 151px #0fa;\n\n  svg {\n    fill: #FFB74D;\n  }\n"], ["\n  border-color: #FFB74D;\n  color: #fff;\n  text-shadow:\n    0 0 7px #fff,\n    0 0 10px #fff,\n    0 0 21px #fff,\n    0 0 42px #0fa,\n    0 0 82px #0fa,\n    0 0 92px #0fa,\n    0 0 102px #0fa,\n    0 0 151px #0fa;\n\n  svg {\n    fill: #FFB74D;\n  }\n"])));
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, rugDocLink: rugDocLink, defiYieldLink: defiYieldLink }),
